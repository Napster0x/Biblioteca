...
const BookDetailModal: React.FC<BookDetailModalProps> = ({
  ...
  const [activeDeleteAction, setActiveDeleteAction] = useState<'delete' | null>(null);
  ...
  const currentDeleteConfig = activeDeleteAction ? deleteConfig : null;
