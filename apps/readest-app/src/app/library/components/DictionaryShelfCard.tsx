...
import type { DictionaryShelfItem } from '@/types/dictionary';
import type { LibraryViewModeType } from '@/types/settings';

interface DictionaryShelfCardProps {
  item: DictionaryShelfItem;
  mode: LibraryViewModeType;
}

const DictionaryShelfCard = ({ item, mode }: DictionaryShelfCardProps) => {
    ...
    >
      ...
      >
        {coverError ? (
          ...
          <img
            src='/images/dictionary-cover.png'
            alt='Diccionario'
...
export default DictionaryShelfCard;
