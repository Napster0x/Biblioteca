...
const publishTextureUpsert = (_item: unknown): void => {};

const publishTextureDelete = (_contentId: string): void => {};
 ...
 */
export const migrateLegacyTextures = async (_envConfig: EnvConfigType): Promise<void> => {};
